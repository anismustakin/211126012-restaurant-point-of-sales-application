...
public class FoodItemCrudTest {
    ...
    private void createFoodItem() {
        ...
        FoodItemContent content1 = OrderFactory.getFoodItemContent(5);
        FoodItemContent content2 = OrderFactory.getFoodItemContent(6);
        
        List<FoodItemContent> contents = new ArrayList<FoodItemContent>();
        
        contents.add(content2);
        contents.add(content1);
        FoodItem foodItem = OrderFactory.getFoodItem("Burger", 12, 5, new BigDecimal("20.00"), contents);
